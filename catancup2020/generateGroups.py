...
s_tier = ["조안나","정예종","윤혜영", "박재완"] # S-Tier players claim, but have no proof of victory. They should not be in same group
...
# %% This is what we would run if groups have different sizes (17 players)
# captains = ["김기환", "조나단", "조예람", "이하나"] # Captains have proof of victory
# captain_with_5 = np.random.randint(0,2) # One of 김기환 or 조나단 will have 5 players
# s_tier = ["조안나", "정예종", "윤혜영"] # Tier A players claim, but have no proof of victory. They should not be in same group
